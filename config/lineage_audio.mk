...
ALARM_PATH := vendor/frosty/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/frosty/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/frosty/prebuilt/common/media/audio/ringtones
