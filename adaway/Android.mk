...
ADBLOCK_SCRIPT := vendor/frosty/adaway/generate.py

TARGET_GENERATED_HOSTS_BLOCKER := $(TARGET_OUT_INTERMEDIATES)/ADBLOCK/hosts.frosty_adblock
...
include $(CLEAR_VARS)
LOCAL_MODULE := hosts.frosty_adblock
