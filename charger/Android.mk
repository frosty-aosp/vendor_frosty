...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_frosty.cpp
LOCAL_MODULE := libhealthd.frosty
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_frosty_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := frosty_charger_res_images
LOCAL_MODULE_TAGS := optional
